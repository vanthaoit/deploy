...
namespace LogixHealth.Eligibility.DataAccess.TORM.CoreFrames.MethodStament.Implements
{
        ...
        where TEntity : class, new()
    {
        ...
        public override int GoStoreProcedure(string name, params ParameterDefinition[] parametersDefinitions)
        {
            throw new NotImplementedException();
        }

        public override Task<int> GoStoreProcedureAsync(string name, params ParameterDefinition[] parametersDefinitions)
        {
            throw new NotImplementedException();
        }
