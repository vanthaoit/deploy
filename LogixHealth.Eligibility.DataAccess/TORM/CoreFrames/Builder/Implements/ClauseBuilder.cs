...
namespace LogixHealth.Eligibility.DataAccess.TORM.CoreFrames.Builder.Implements
{
    public abstract class ClauseBuilder : IClauseBuilder
    {
        public const string DefaultSchema = SchemaDatabaseCosntants.SCHEMA_DATABASE;
