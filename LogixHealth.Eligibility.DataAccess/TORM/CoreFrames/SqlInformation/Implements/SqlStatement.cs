...
using LogixHealth.Eligibility.Models.Entities.System;
using System;
using System.Linq;
using System.Threading.Tasks;

namespace LogixHealth.Eligibility.DataAccess.TORM.CoreFrames.SqlInformation.Implements
{
        ...
        where TEntity : class, new()
    {
        protected SqlStatement(IStatementExecutor statementExecutor, IEntityMapper entityMapper)
        {
            ...
            this.TableSchema = SchemaDatabaseCosntants.SCHEMA_DATABASE;
        ...
        public abstract TResult GoStoreProcedure(string name,
            params ParameterDefinition[] parametersDefinitions);

        public abstract Task<TResult> GoStoreProcedureAsync(string name,
            params ParameterDefinition[] parametersDefinitions);
