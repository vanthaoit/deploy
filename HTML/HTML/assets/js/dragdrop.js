! function(e) {
	...
	e.FileDialog = function(a) {
      ...
      t = e([
        ...
        "             <h6 class='text-dark cg-bold mb-3'>[Name]</h6>",
		...
		"         		<div class='w-100'>",
		"           		<button class='btn btn-outline-primary bfd-ok'", 
		"									data-dismiss='modal'>", o.cancel_button,
		"					</button>",
		"           		<button class='btn btn-primary float-right bfd-cancel'>", o.ok_button,
		"					</button>",
		"         		</div>",
		"       	</div>",
        "        </div>",
        ...
        var s = e(["<div class='col-12 pl-0 py-1 cg-bold bfd-info'>", 
		  ...
		  "</div>",
          "	   <div class='col-1'>",
		  "    <span class='fa fa-times bfd-remove'></span>&nbsp;",
		  "    </div>"
